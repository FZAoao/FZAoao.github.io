const translations = {
  en: {
    ...
    "hero.desc": "I am FZAoao, a furry fan with a dragon cub fursona. I turn ideas into code with Node.js, Python, Java, C, JavaScript, and Vue. I use VSCode and IDEA, and I run CubeXMC and S3API.",
    "hero.email": "Email Me",
    "section.about": "About",
    "about.name": "Name",
    ...
    "stack.csharp": "For enterprise applications, game development with Unity, and .NET ecosystem.",
    "stack.rust": "Memory-safe systems programming, high-performance tools, and concurrent applications.",
  ...
  zh: {
    ...
    "hero.desc": "我是 FZAoao，Furry 控，兽设是一只龙崽。我会用 Node.js、Python、Java、C、JavaScript 和 Vue 把想法写成代码。常用 VSCode 和 IDEA，也在运营 CubeXMC 和 S3API。",
    "hero.email": "联系我",
    "section.about": "关于",
    "about.name": "网名",
    "about.identity": "身份",
    ...
    "stack.csharp": "用于企业级应用、Unity 游戏开发和 .NET 生态系统。",
    "stack.rust": "内存安全的系统编程、高性能工具和并发应用程序。",
